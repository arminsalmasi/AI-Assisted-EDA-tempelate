...
"""))
    ...
    cells.append(nbf.v4.new_code_cell("""promo_obs = pd.merge(customers[customers['full_30d_observation_flag'] == 1][['user_id', 'returned_after_first_order_30d']], 
...
"""))
    ...
    # 12. Section 3 Header: Usage Breadth (Hypothesis 3)
